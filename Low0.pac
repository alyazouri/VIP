...
function isJordan(host){
  return (
isInNet(host,"37.238.0.0","255.255.0.0") ||
isInNet(host,"46.32.224.0","255.255.224.0") ||
isInNet(host,"78.108.128.0","255.255.240.0") ||
isInNet(host,"82.212.64.0","255.255.192.0") ||
isInNet(host,"87.236.232.0","255.255.248.0") ||
isInNet(host,"94.249.0.0","255.255.128.0") ||
isInNet(host,"109.107.0.0","255.255.128.0") ||
isInNet(host,"176.28.0.0","255.254.0.0") ||
isInNet(host,"185.0.24.0","255.255.252.0") ||
isInNet(host,"188.247.0.0","255.255.0.0") ||
