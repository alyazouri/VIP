...
function isJordan(host){
  return (
    isInNet(host,"82.212.64.0","255.255.192.0") ||   /* AS8376 Orange */
    isInNet(host,"149.200.128.0","255.255.128.0") || /* AS8376 Orange */
    isInNet(host,"188.247.80.0","255.255.248.0") ||  /* AS48832 Zain */
    isInNet(host,"212.34.0.0","255.255.224.0")       /* AS8697 Jordan Telecom */
  );
}
