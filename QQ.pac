...
var JORDAN_MATCH_IPV4 = [
  ...
  ["82.212.64.0",   "255.255.192.0"],   // /18 — Orange JO (AS8697 / Al-Hadatheh)
  ["94.249.0.0",    "255.255.128.0"],   // /17 — Umniah (AS9038 / Orange)
  ["176.29.0.0",    "255.255.0.0"],     // /16 — Zain JO

  // ── Tier 2 Verified Local Loops (خوادم إربد، الزرقاء، وعمّان المحلية بحتة) ──
...
var JORDAN_MATCH_IPV6 = [
  "2a01:9700::/29", "2a01:e240::/29", "2a02:9c0::/29", "2a01:1d0::/29",
  "2a02:c040::/29", "2a01:ee40::/29", "2a02:2558::/29", "2a02:e680::/29",
