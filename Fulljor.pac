...
// IPv4: 128 نطاق | IPv6: 40 نطاق (أول خانتان ثابتتان)
// ======================================================
...
// ========= IPv6 الأردنية – 40 بادئة (خانتان ثابتتان فقط) =========
// الصيغة: "XXXX:XXXX:" — أول 32 بت ثابتة، الباقي يُطابق تلقائياً
var JO_IPV6 = [
  "2001:32c0:",   // /29
  "2001:67c:",    // /48 — اختُصرت من 2001:67c:2124: إلى خانتين
  "2a00:18d0:",   // /32
  "2a00:18d8:",   // /29
  "2a00:4620:",   // /32
  "2a00:76e0:",   // /32
...
// يُطابق أول خانتين من عنوان IPv6 فقط (أول 32 بت)
// مثال: "2a02:c040:1234:abcd::1" → يُطابق البادئة "2a02:c040:"
...
function FindProxyForURL(url, host) {
  ...
  // 4. FORCE_ALL – كل الحركة عبر البروكسي
